...
<div class="icon" :class="{'iborder':IconBorder }" aria-hidden="true">
      ...
      <path d="M8,4H5C4.447,4,4,4.447,4,5v3c0,0.552,0.447,1,1,1h3c0.553,0,1-0.448,1-1V5
	...
	c0,0.552,0.447,1,1,1h3c0.553,0,1-0.448,1-1v-3C16,11.448,15.553,11,15,11z"/></svg>
</div>
